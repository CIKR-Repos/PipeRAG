      ...
      <div class="hidden lg:flex lg:w-1/2 bg-surface-0 flex-col items-center justify-center
        ...
        <div class="relative z-10 text-center px-12 max-w-md">
          ...
          <p class="text-text-secondary leading-relaxed">
            Build powerful RAG pipelines with zero code. Upload your documents and deploy
            AI chatbots instantly.
          </p>
          <div class="mt-10 flex items-center justify-center gap-8">
            <div class="text-center">
              <div class="text-2xl font-bold text-text-primary">10K+</div>
              <div class="text-xs text-text-tertiary mt-1">Chatbots</div>
            </div>
            <div class="w-px h-10 bg-border"></div>
            <div class="text-center">
              <div class="text-2xl font-bold text-text-primary">99.9%</div>
              <div class="text-xs text-text-tertiary mt-1">Uptime</div>
            </div>
            <div class="w-px h-10 bg-border"></div>
            <div class="text-center">
              <div class="text-2xl font-bold text-text-primary">&lt;2s</div>
              <div class="text-xs text-text-tertiary mt-1">Response</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="flex-1 flex items-center justify-center px-6 py-12">
        <div class="w-full max-w-sm">
          ...
          <div class="lg:hidden text-center mb-10 reveal">
            ...
            <h1 class="text-2xl font-bold text-text-primary tracking-tight">Login to PipeRAG</h1>
          </div>

          <!-- Desktop heading -->
          <div class="hidden lg:block mb-10 reveal">
            <h1 class="text-2xl font-bold text-text-primary tracking-tight mb-2">Welcome back</h1>
            <p class="text-text-secondary text-sm">Sign in to your account to continue.</p>
          </div>
          ...
          <p class="text-center text-sm text-text-tertiary mt-8 reveal reveal-d4">
...
export class LoginComponent {
  ...
  async onSubmit() {
    ...
    try {
      ...
      const msg = e?.error?.error || 'Login failed';
      this.error.set(msg);
